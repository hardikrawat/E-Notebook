<%@page import="com.User.UserDetails,java.sql.*"%>
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
  <a class="navbar-brand" href="#"><i class="fa fa-book" aria-hidden="true"></i> ENotesbook</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="showNotes.jsp"><i class="fa fa-address-book-o" aria-hidden="true"></i> Show Note</a>
      </li>
    </ul>
    <%
     HttpSession s=request.getSession();
     UserDetails u=(UserDetails)s.getAttribute("userO");
     if(u!=null){%>
         <a href="#" class="btn btn-light my-2 my-sm-0 mr-2" type="submit" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-user-circle-o" aria-hidden="true"></i> <%= u.getName() %> </a>
